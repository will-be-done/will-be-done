    ...
    <div className="flex flex-col gap-3 px-5 py-5">
      <div className="rounded-xl bg-white/[0.03] p-4 ring-1 ring-white/8">
        <button
          ...
          className="float-right ml-3 mb-1 flex cursor-pointer items-center gap-1.5 whitespace-nowrap rounded-lg bg-white/[0.07] px-3 py-2 text-[12px] font-medium text-content ring-1 ring-white/12 transition-all hover:bg-white/10 hover:ring-white/20 disabled:cursor-not-allowed disabled:opacity-50"
        >
        ...
        <div className="float-left mt-0.5 mr-3 flex h-8 w-8 items-center justify-center rounded-lg bg-white/[0.05] text-content-tinted ring-1 ring-white/10">
      ...
      <div className="overflow-hidden rounded-xl bg-white/[0.03] ring-1 ring-white/8">
                ...
                >
                  ...
                  <div className="flex items-center justify-self-start self-start gap-1 sm:col-start-2 sm:row-start-1 sm:justify-self-end">
                    <button
                      ...
                      className="cursor-pointer rounded-lg p-2 text-content-tinted/60 transition-colors hover:bg-white/8 hover:text-content"
                    >
                      {isRevealed ? (
