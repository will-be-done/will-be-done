      ...
      <div className="rounded-xl bg-overlay ring-1 ring-border p-4">
        <div>
          <button
            ...
            className="float-right ml-3 mb-1 flex cursor-pointer items-center gap-1.5 rounded-lg bg-overlay-hover px-3 py-2 text-[12px] font-medium text-content ring-1 ring-border transition-all hover:bg-overlay-hover hover:ring-border disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
          >
      ...
      <div className="rounded-xl bg-overlay ring-1 ring-border p-4">
        ...
        <div className="flex items-center gap-2 mt-3">
          <input
            ...
            className="flex-1 min-w-0 rounded-lg bg-overlay px-3 py-2 text-[12px] text-content placeholder:text-content-tinted/40 ring-1 ring-border outline-none focus:ring-border transition-all"
          />
          <button
            onClick={handleTodoistImport}
            disabled={todoistImporting || !todoistToken.trim()}
            className="flex flex-shrink-0 cursor-pointer items-center gap-1.5 rounded-lg bg-overlay-hover px-3 py-2 text-[12px] font-medium text-content ring-1 ring-border transition-all hover:bg-overlay-hover hover:ring-border disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
          >
