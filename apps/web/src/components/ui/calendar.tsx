...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-popover-calendar group/calendar p-3 [--cell-size:--spacing(8)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-(--cell-size) aria-disabled:opacity-50 p-0 select-none cursor-pointer text-calendar-header hover:text-content hover:bg-panel-tinted",
        ...
        caption_label: cn(
          "select-none font-medium text-calendar-header",
          captionLayout === "label"
            ? "text-sm"
            : "rounded-md pl-2 pr-1 flex items-center gap-1 text-sm h-8 [&>svg]:text-calendar-header [&>svg]:size-3.5",
          defaultClassNames.caption_label
        ),
        table: "w-full border-collapse",
        weekdays: cn("flex", defaultClassNames.weekdays),
        weekday: cn(
          "text-calendar-weekday rounded-md flex-1 font-semibold text-[0.8rem] select-none uppercase",
        ...
        week_number: cn(
          "text-[0.8rem] select-none text-content-tinted",
        ...
        today: cn(
          "text-content rounded-md data-[selected=true]:rounded-none font-bold",
        ...
        disabled: cn(
          "text-content-tinted opacity-50",
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          if (orientation === "left") {
            return (
              <ChevronLeftIcon className={cn("size-4 text-calendar-header", className)} {...props} />
            )
          }
          ...
          if (orientation === "right") {
            return (
              <ChevronRightIcon
                className={cn("size-4 text-calendar-header", className)}
                {...props}
              />
            )
          }
          ...
          return (
            <ChevronDownIcon className={cn("size-4 text-calendar-header", className)} {...props} />
          )
        },
