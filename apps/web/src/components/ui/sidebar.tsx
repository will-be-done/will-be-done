...
function SidebarProvider({
  ...
  const setWidth = React.useCallback(
    (width: number) => onWidthChange?.(width),
    [onWidthChange]
  )
  ...
  const contextValue = React.useMemo<SidebarContextProps>(
    ...
    [state, open, setOpen, isMobile, openMobile, setOpenMobile, toggleSidebar, setWidth, isResizing, setIsResizing]
  )
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-sidebar text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:hidden border-ring"
          style={
            {
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "[[data-state=collapsed][data-collapsible=offcanvas]_&]:hidden",
        className
      )}
      {...props}
    />
