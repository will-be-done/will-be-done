              ...
              <div>
                ...
                <div className="grid w-fit grid-cols-2 gap-3">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 rounded-xl border border-blue-500/30 bg-blue-500/[0.07] px-5 py-3 text-[14px] font-medium text-blue-300 transition-all hover:border-blue-400/50 hover:bg-blue-500/[0.12] hover:text-blue-200"
                  >
                    <svg
                      className="h-4 w-4"
                      fill="none"
              ...
              <div className="mx-auto max-w-xl text-center">
                ...
                <div className="flex flex-wrap justify-center gap-3">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 rounded-xl border border-blue-500/30 bg-blue-500/[0.07] px-6 py-3 text-[14px] font-medium text-blue-300 transition-all hover:border-blue-400/50 hover:bg-blue-500/[0.12] hover:text-blue-200"
                  >
                    <svg
                      className="h-4 w-4"
                      fill="none"
