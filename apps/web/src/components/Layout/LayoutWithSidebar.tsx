      ...
      >
        ...
        <SidebarInset className="min-h-0 bg-transparent">
          <div className="relative h-full">
            <SidebarTrigger className="absolute left-2 top-2 z-20 cursor-pointer text-content-tinted backdrop-blur-md hover:text-primary safari:backdrop-blur-none desktop-macos:data-[open=false]:ml-20 desktop-macos:top-2.5 [app-region:no-drag]" />
            {children}
            {/* {!isDemoMode() && ( */}
